      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <button onClick={handleGoogle} disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-lg border-[2px] border-foreground/20 bg-white hover:bg-gray-50 transition-colors text-sm font-medium shadow-[2px_2px_0px_rgba(0,0,0,0.08)] disabled:opacity-50">
            {loading ? (
